...
type Node struct {
	...
	// ExtraCreateArgs are extra arguments passed to the underlying provider during node creation
	ExtraCreateArgs []string `yaml:"extraCreateArgs,omitempty" json:"extraCreateArgs,omitempty"`
}
